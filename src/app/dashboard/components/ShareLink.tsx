      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 uppercase tracking-wide">Toplam Görüntüleme</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-gray-900">0</p>
            <p className="text-xs text-gray-500 uppercase tracking-wide">Toplam Yorum</p>
          </div>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg p-3 border border-blue-100">
          <p className="text-xs text-blue-700">
            💡 <strong>İpucu:</strong> Bu linki sosyal medya profillerinize, e-posta imzanıza veya web sitenize ekleyerek daha fazla müşteri yorumu toplayabilirsiniz.
          </p>
        </div>
      </CardContent>
    </Card>
