...
export const metadata: Metadata = {
  ...
  description: "Freelancer'lar ve e-ticaret siteleri için müşteri yorumlarını toplamayı, yönetmeyi ve web sitelerinde şık bir şekilde sergilemeyi otomatikleştiren araç. Video yorumları, metin yorumları ve modern widget'lar ile sosyal kanıtınızı güçlendirin.",
  keywords: [
    "müşteri yorumları",
    "video yorumları", 
    "sosyal kanıt",
